...
#define SS1  "                     `. ___                                          "
#define SS2  "                    __,' __`.                _..----....____         "
#define SS3  "        __...--.'``;.   ,.   ;``--..__     .'    ,-._    _.-'         "
#define SS4  "  _..-''-------'   `'   `'   `'     O ``-''._   (,;') _,'            "
#define SS5  ",'________________                          \\`-._`-','               "
#define SS6  " `._              ```````````------...___   '-.._'-:                 "

#define SS7  "                   `-:._____/______/___/____`.     \\  `              "
#define SS8  "                               |       `._    `.    \\                "
#define SS9  "                               '_________`-_   `.   `.___            "
#define SS10 "                                                  `------'`          "
#define SS11 "                                                                     "

#define RKT1 "    ```--.._      ,.                     ````--...__\\-._----__      "
#define RKT2 "            `.--. `-`                       ____    |  |   `   --    "
#define RKT3 "              `. `.                       ,'`````.  ;  ;` `  ` ---   "
#define RKT4 "                `._`.        __________   `.      \\'__/-____--      "

#define RKT5 "    ```--.._      ,.                     ````--...__\\-._--__        "
#define RKT6 "            `.--. `-`                       ____    |  |   ` -       "
#define RKT7 "              `. `.                       ,'`````.  ;  ;` ` --       "
#define RKT8 "                `._`.        __________   `.      \\'__/-__-         "